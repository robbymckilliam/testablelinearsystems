...
Consider the convolution $u * u$ of the step sequence with itself.  The $n$th element of the the convolution is
\[
(u * u)_n = \sum_{m \in \ints} u_m u_{n-m} = \sum_{m = 0}^n 1 = n+1.
\] 
