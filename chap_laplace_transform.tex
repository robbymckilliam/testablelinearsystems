...
We now study the Laplace transform and the region of convergence in more detail.  The region of convergence $\roc x = \cep \dom x$ is precisely the set of complex numbers $s$ such that $x(t) e^{-s t}$ is absolutely integrable (Exercise~\ref{exer:finhandroch}), that is, such that,
\[
