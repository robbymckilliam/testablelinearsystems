...
The following argument is due to Qiaochu Yuan (http://math.stackexchange.com/questions/1079/sum-of-two-periodic-functions).  Suppose $\sin(t) + \sin(\pi t)$ is periodic.  Then
\[
