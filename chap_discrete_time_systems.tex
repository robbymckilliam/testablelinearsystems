...
\]
where $a,b \in \complex$.  This is called a~\term{second order difference equation}.  Suppose that $H$ is a discrete time system with reponse $y=H(x)$ satisfying the equation $x = y - aT_{P)(y) - b T_{P}(y)$.  The spectrum of this system is
\[
