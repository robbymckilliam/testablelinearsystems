...
Unless otherwise stated we will assume the domain of $I_\infty$ to be the subset of locally integrable signals for which $\int_{-\infty}^0 \abs{x(t)} dt < \infty$ (Exercise~\ref{excer:domainintegrator}).    %The set of all linear combinations of signals of $L^1$ and right sided locally integrable signals also forms a domain.
