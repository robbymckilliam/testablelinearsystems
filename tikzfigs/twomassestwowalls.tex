...
\newcommand{\animations}[1]{
    ...
    \pgfmathparse{(2 - 8*#1*#1)*exp(-#1*#1)}\pgfmathresult \let\g\pgfmathresult
    %draw animated line
    ...
    \begin{scope}[xshift=-3cm,yshift=-3.6cm]
      ...
      \node (M1) [minimum width=1cm,minimum height=2cm,style={draw,outer sep=0pt,thick},xshift=2.65cm+\p cm] {$M_1$};
      ...
      \node (M2) [minimum width=1cm,minimum height=2cm,style={draw,outer sep=0pt,thick},xshift=5.15cm+\g cm] {$M_2$};
