...
Let $H$ be a stable discrete time system with absolutely summable discrete impulse response $h$.  Equivalently the domain of the transfer function $\lambda H$ contains the imaginary axis, that is, the set $\cep \dom_z h$ contains the imaginary axis.  The spectrum of $H$ is
\[
