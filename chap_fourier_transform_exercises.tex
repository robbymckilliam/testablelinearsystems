...
\harditem \label{exer:ftdftswapsummationldct}Let $c$ be an absolutely summable sequence.  Show that 
\[
...
\harditem \label{exer:ftdftswapsummationldct}Let $c$ be a square summable sequence and let  
\[
