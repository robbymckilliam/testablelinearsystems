...
&= \sum_{m \in \ints} f_m  G T_{Pm} x  \qquad \text{(time invariant of $G$} \\
...
We now consider some example z-transforms.  Consider first the step sequence $u$.  The region of convergence $\roc_\calZ u$ is all those complex numbers with absolutely value greater than one because
\[
