...
\begin{figure}[p]
  ...
  \end{tikzpicture}
  \caption{The signal $x(t) = e^{-t^2}$ and shifts $x(t - \tau) = e^{-(t-\tau)^2}$ for $\tau = 1.5$ and $-3$.} \label{fig:timeshifter}
\end{figure}
