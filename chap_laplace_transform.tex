...
% \]
% and so, we will approximate $g(t)$ by zero when $\abs{t} > T = 10^3$.  This approximation is accurate to 3 decimal places. For $\abs{t} < 10^3$ 
% % We first truncate the upper bound of the integral,
% % \[
% % g(t) \approx \int_{0}^{b} 
% % \] 
% % We choose $K$ 
