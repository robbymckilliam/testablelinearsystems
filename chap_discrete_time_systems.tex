...
\vspace{0.5cm}
  ...
  \end{tikzpicture}
\captionsetup{type=figure} 
\captionof{figure}{Plot of the magnitude of the Fourier transform $\calF y$ of the bandlimited signal .  The plot looks similar to that of the magnitude of the Fourier transform of the original audio signal (Figure~\ref{fig:test:fouriertransformlecturevideo}) except that the spikes at $\pm\SI{8}{\kilo\hertz}$ and the elevated region between \SI{4900}{\hertz} and \SI{5900}{\hertz} no longer exist.}\label{fig:test:firfilteredlecturevideo}
\end{shaded}
\end{randomfloat}
