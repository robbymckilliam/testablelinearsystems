...
Let $H$ be a stable discrete time system with absolutely summable discrete impulse response $h$.  The signal $e^{2\pi j f t} \in \dom_z h$ for all $f \in \reals$ since
\[
