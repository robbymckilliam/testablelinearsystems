...
\caption{Signals $x$ and their periodic summations $\sum_{m\in\ints}x(f + Fm)$ where $F = 1/P$. The periodic summation is shown by the solid lines on the left.  The dashed lines are the individual translations being summed.} \label{fig:periodisedfunctions}
\end{figure}
