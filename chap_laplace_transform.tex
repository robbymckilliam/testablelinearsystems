...
\[
g(t) = \int_{-\pi}^{\pi} \frac{\cos(\omega t) + \omega t \sin(\omega t)}{1 + V^2\omega^2t^2} \; dt \qquad \text{(Exercise~\ref{?})}
\]
where $V = \tfrac{F}{r}$.  An approximation of $g(t)$ is made Reiman sum the trapezoidal sum
\[
